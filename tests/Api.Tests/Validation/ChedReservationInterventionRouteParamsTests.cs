...
public class ChedReservationInterventionRouteParamsTests
{
    ...
    {
        var model = new ChedReservationInterventionRouteParams
        {
            ChedCertificateId = "",
            CustomsDocumentReference = "MRN-123",
        };
        ...
        results
            .Should()
            .ContainSingle(x =>
                x.MemberNames.Contains(nameof(ChedReservationInterventionRouteParams.ChedCertificateId))
            );
    }
    ...
    public void Should_Fail_When_CustomsDocumentReference_Is_Null_Or_Whitespace()
    {
        ...
        results
            .Should()
            .ContainSingle(x =>
                x.MemberNames.Contains(nameof(ChedReservationInterventionRouteParams.CustomsDocumentReference))
            );
    }
